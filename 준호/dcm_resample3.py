...
for r_dpath in [os.path.join('E:/Dataset/Disc/Dataset', d) for d in os.listdir('E:/Dataset/Disc/Dataset')]:
    ...
    try:
        ...
        new_d_path = r_dpath.replace('Dataset/Disc', 'Dataset/Disc_2D_resampled_nonthickness')
        new_l_path = r_lpath.replace('Dataset/Disc', 'Dataset/Disc_2D_resampled_nonthickness')
